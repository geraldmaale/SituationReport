...
namespace SR.Data.Migrations
{
    ...
    [Migration("20220517202733_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SR.Shared.Entities.OperationProcessingDetail", b =>
                {
                    b.Property<Guid>("OperationProcessingDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("OperationProcessingId")
                        .HasColumnType("uuid");

                    b.Property<int>("OperationTypeId")
                        .HasColumnType("integer");

                    b.HasKey("OperationProcessingDetailId");

                    b.HasIndex("OperationProcessingId");

                    b.HasIndex("OperationTypeId");

                    b.ToTable("OperationProcessingDetails");
                });

            modelBuilder.Entity("SR.Shared.Entities.OperationsProcessing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OperationsProcessings");
                });
            ...
            modelBuilder.Entity("SR.Shared.Entities.OperationProcessingDetail", b =>
                {
                    b.HasOne("SR.Shared.Entities.OperationsProcessing", "OperationsProcessing")
                        .WithMany("OperationsProcessingDetails")
                        .HasForeignKey("OperationProcessingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("OperationsProcessing");
                });
            ...
            modelBuilder.Entity("SR.Shared.Entities.OperationsProcessing", b =>
                {
                    b.Navigation("OperationsProcessingDetails");
                });
